...
window.__RISE_STABLE_ROOT_V4__={version:'2.1.1',performance:'2.2',navigation:'instant-four-tab',firstLoad:'immediate-capture',prewarm:'primary-only',reviewNavigation:'canonical-page'};

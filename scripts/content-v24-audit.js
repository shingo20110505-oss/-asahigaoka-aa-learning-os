...
for(const s of subs){
  ...
  result.deepAudit[s]={exactDuplicateQuestionAnswer:exactDups.length,exactDuplicateSamples:exactDups.slice(0,20),conflictingAnswersForSamePrompt:conflicts.length,conflictSamples:conflicts.slice(0,30),unitCounts,difficultyCounts,repeatedTemplates};

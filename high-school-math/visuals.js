...
const diagrams={
 ...
 s12:()=>wrap('対称移動で折れ線を一直線にする図',`<path d="M30 136 H290" style='${line}'/><path d="M72 54 L158 136 L256 48" style='${accent}'/><path d="M72 54 L158 136 L256 224" style='${dash}'/><path d="M72 54 L256 224" style='${soft}'/>${dot(72,54,'A')}${dot(158,136,'P')}${dot(256,48,'B')}${t(262,166,"B'",true)}`,'一方を対称移動すると最短経路が一直線になる'),

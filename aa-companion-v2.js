...
const s=document.createElement('script');s.src='./companion7-runtime.js?v=7.5.0-loginzip1';s.async=false;s.onload=()=>{killVisuals();queuePatch()};s.onerror=()=>console.error('Companion login runtime failed to load');document.head.appendChild(s);
})();
...
function showQuestion(){
 ...
 const q=session.questions[session.index];session.locked=false;questionStarted=performance.now();ui.feedback.className='feedback hidden';ui.feedback.innerHTML='';ui.next.classList.add('hidden');ui.choices.innerHTML='';ui.answerInput.value='';ui.inputRow.classList.toggle('hidden',!q.input);ui.choices.classList.toggle('hidden',!!q.input);ui.speak.classList.toggle('hidden',!q.speak);ui.speak.onclick=()=>q.speak&&speak(q.speak);

...
国語の文章・対話・古文・選択肢は全てアプリ作成です。説明文667字・文学文591字を含む読解問題では、各問に本文根拠と読解観点を持たせ、誤答にも「言い過ぎ」「因果の飛躍」「本文外」「逆」などの誤りの型と個別理由を付けています。複数選択と部分点を扱い、試験中には採点情報を表示しません。
...
- v2.2.5でも保存キー `asahi_learning_os_v1` とschema 4を固定し、入試・演習それぞれの教科内単元設定、長文難度設定、数学の高校公式単元、正解フィードバック設定を同じ保存領域で維持

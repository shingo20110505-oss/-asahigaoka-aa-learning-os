...
function make(){
  ...
  wrap.innerHTML=`
    ...
    <p class="sub" style="margin:0 0 12px">社会年表、国語語彙、古文・漢文単語を一覧で反復できます。問題演習の前後に、短時間で見直せます。</p>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:10px">
      ...
      <a href="./classics-vocab/" style="text-decoration:none;color:inherit;border:1px solid var(--line);border-radius:16px;padding:14px;background:linear-gradient(145deg,var(--card),var(--purple2));display:block;min-height:132px">
        <div style="font-size:11px;font-weight:900;color:var(--purple);letter-spacing:.08em">古文・漢文</div>
        <div style="font-size:19px;font-weight:900;margin:5px 0">単語帳 1,000</div>
        <div class="sub" style="font-size:11px;line-height:1.55">古文700語・漢文300語を重複なしで確認。読み・意味・要復習を一覧で管理。</div>
        <div style="margin-top:10px;font-weight:900;color:var(--purple);font-size:12px">単語帳を開く →</div>
      </a>
    </div>`;
  return wrap;
}

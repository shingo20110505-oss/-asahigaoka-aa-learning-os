...
const VERSION = '2.2.9';
const CACHE_NAME = `asahigaoka-aa-os-${VERSION}-companion750-loginzip1-analytics1-prodtest1-examples1-quality1-chrono7-v23k`;
...
const APP_SHELL = [
  ...
  new URL('explanation-examples-v1.js', BASE).href,

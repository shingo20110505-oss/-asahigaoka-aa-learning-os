...
async function ensureChronologia7(){if(window.__CHRONOLOGIA_V7_RUNTIME__||document.querySelector('script[data-chronologia-v7]'))return;await loadScript('./chronologia-v7-data-3.js?v=7.1.0');await loadScript('./chronologia-v7-data-4.js?v=7.2.0');try{if(window.CHRONO_V7_EXTRA_READY)await window.CHRONO_V7_EXTRA_READY}catch(e){console.error('Chronologia 1000-item supplement failed',e)}await loadScript('./chronologia-curated-501-600.js?v=1.0.0');await loadScript('./chronologia-curated-601-700.js?v=1.0.0');await loadScript('./chronologia-curated-701-800.js?v=1.0.0');await loadScript('./chronologia-curated-801-900.js?v=1.0.0');await loadScript('./chronologia-curated-901-1000.js?v=1.0.0');await loadScript('./chronologia-curated-final-fixes.js?v=1.0.0');if(window.__CHRONOLOGIA_V7_RUNTIME__)return;const s=document.createElement('script');s.dataset.chronologiaV7='1';s.src='./chronologia-v7-runtime.js?v=7.2.0';s.async=false;document.head.appendChild(s)}
